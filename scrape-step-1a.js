// STEP 1A: Fundability Foundation (first 6) - Paste in console at business-credit-builder page
(async function scrapeStep1A() {
  ...
  dl.download = `fundability-step-1a.json`; dl.textContent = `💾 Download Step 1A`;
