// STEP 1B: Fundability Foundation (last 6) - Paste in console at business-credit-builder page
(async function scrapeStep1B() {
  ...
  const SUB_ITEMS = [
    'Website and Email', 'Business Licenses',
  ...
  dl.download = `fundability-step-1b.json`; dl.textContent = `💾 Download Step 1B`;
